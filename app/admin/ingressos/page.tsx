...
export default function AdminIngressosPage() {
  ...
  const handleSuccess = () => {
    fetchIngressos();
    // Não fechar o dialog - manter aberto para criar mais ingressos
  };
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        <AdminLoading message="Carregando ingressos..." />
      ) : ingressosFiltrados.length === 0 ? (
        <Card>
          <CardContent className="pt-6">
            <div className="text-center py-12">
              <p className="text-gray-600 mb-4">Nenhum ingresso encontrado.</p>
              <Button
              ...
              >
                <CardHeader>
                  <div className="flex justify-between items-start mb-2">
                    <CardTitle className="text-xl">{ingresso.tipo}</CardTitle>
                    <span
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold">{ingresso.vendidos}</span>
                    </div>
                  </div>
